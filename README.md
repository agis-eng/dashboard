...
- `opportunities.yaml` – Growth pipeline ideas, partner outreach tracker items, questionnaire prompts, and draft email scaffolding.
...
- `dist/opportunities/index.html` – Internal growth pipeline / outreach planning view.
